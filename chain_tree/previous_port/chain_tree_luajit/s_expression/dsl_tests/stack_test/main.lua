-- ============================================================================
-- main_stack_test.lua
-- LuaJIT test driver for stack_test
-- Mirrors stack_test C driver (test_dispatch / main)
-- No user functions — stack_test_register_all is empty in C.
-- ============================================================================
...
local ok, md = pcall(require, "stack_test_module")
if not ok then
    print("❌ FATAL: Could not load stack_test_module: " .. tostring(md))
    os.exit(1)
end
...
local function test_dispatch(mod, md)
    ...
    print("╚════════════════════════════════════════╝")
    print("")
    print("Testing stack test with tick loop...")
